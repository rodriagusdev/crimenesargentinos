...
export default function GameButton({
	...
	return (
		<button
			...
			disabled={disabled}
			className="relative group w-full p-4 text-sm modern-button flex items-center justify-center rounded-lg"
			style={baseStyle}
		>
			<span className="absolute left-0 opacity-0 translate-x-[-4px] transition-all duration-200 group-hover:opacity-100 group-hover:translate-x-0 icon-float">
				{icon}
			</span>
