...
export default function CostFeedbackToast({
  ...
  return (
    <div className="fixed top-20 left-1/2 -translate-x-1/2 z-[70] pointer-events-none select-none transition-all duration-300 flex flex-col items-center gap-2">
      ...
      {unlockedClue && (
        <div className="px-5 py-2.5 rounded-2xl backdrop-blur-md bg-[rgba(15,25,35,0.95)] border border-amber-400/60 shadow-[0_12px_35px_rgba(225,195,128,0.25)] flex items-center gap-2.5 animate-bounce">
          <span className="text-lg">🔍</span>
          <div className="flex flex-col items-start font-mono">
            <span className="text-[10px] uppercase font-bold text-[#E1C380] tracking-wider">
              ¡Nueva Pista Descubierta!
            </span>
            <span className="text-xs text-[#FFF3C7]/95 font-semibold">
              &quot;{unlockedClue}&quot;
            </span>
          </div>
        </div>
